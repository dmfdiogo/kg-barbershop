...
VOCÊ É DONO DE
  proxy.ts, lib/tenant/context.ts, lib/auth/session.ts, lib/auth/rbac.ts,
  lib/auth/types.ts
...
ENTREGUE
  - Proxy (proxy.ts) resolvendo o tenant nesta ordem: Host casando com Tenant.customDomain,
