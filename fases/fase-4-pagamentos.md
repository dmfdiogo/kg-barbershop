...
| **F4.1** | Conta de recebimento: `createMerchantAccount`, estados de KYC, criptografia da chave em repouso, caminho degradado `ON_SITE` | `lib/payments/merchant.ts`, `app/(dashboard)/painel/financeiro/conta/**` | F4.0 | 3 |
...
| **F4.3** | Saldo, extrato e estorno dentro do painel | `app/(dashboard)/painel/financeiro/extrato/**`, `app/(dashboard)/painel/financeiro/page.tsx` | F4.0, F4.1 | 2,5 |
