export const DESIGN = {
    // Layout
    layout: {
        pageContainer: "min-h-screen bg-dark-bg text-text-primary",
        contentContainer: "p-4 md:p-8 max-w-7xl mx-auto w-full",
    },

    // Cards
    card: {
        base: "bg-dark-card rounded-xl shadow-lg border border-gray-800",
    ...
    // Inputs
    input: {
        base: "w-full px-4 py-3 border border-gray-700 rounded-lg focus:ring-1 focus:ring-primary focus:border-primary outline-none bg-dark-input text-white placeholder-gray-500 transition-all",
        select: "w-full px-4 py-3 border border-gray-700 rounded-lg focus:ring-1 focus:ring-primary focus:border-primary outline-none bg-dark-input text-white appearance-none",
    },
    ...
    button: {
        ...
        secondary: "bg-dark-input text-white font-medium py-3 px-6 rounded-lg hover:bg-gray-700 transition-all border border-gray-700",
    ...
    selectionCard: {
        ...
        unselected: "border-gray-700 hover:border-gray-500 bg-dark-input",
    }
};
